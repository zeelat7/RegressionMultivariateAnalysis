...
amesiowa.df$dropConditions <- ifelse(amesiowa.df$SubClass!= 020 & amesiowa.df$SubClass != 060 & amesiowa.df$SubClass != 080 & amesiowa.df$SubClass != 160,'01: Not SFR',
...
final.pop <- data.frame(myeligible.population$SubClass, myeligible.population$Zoning, myeligible.population$LotArea, 
                        myeligible.population$Street, myeligible.population$Utilities, myeligible.population$BldgType, myeligible.population$HouseStyle, 
                        myeligible.population$OverallQual, myeligible.population$OverallCond, myeligible.population$YearBuilt, myeligible.population$YearRemodel,
                        myeligible.population$ExterQual, myeligible.population$ExterCond, myeligible.population$BsmtFinType1, myeligible.population$FirstFlrSF, 
                        myeligible.population$GarageCars, myeligible.population$PavedDrive, myeligible.population$PoolArea, myeligible.population$CentralAir, 
                        myeligible.population$SalePrice)
...
boxplot(myeligible.population$SalePrice, ylim = c(60000,760000), col = 'deepskyblue', main = 'Sales Price Box Plot')
qqplot(myeligible.population$YearBuilt, myeligible.population$SalePrice)
plot(myeligible.population$YearBuilt, myeligible.population$SalePrice)
min(myeligible.population$SalePrice)
max(myeligible.population$SalePrice)
